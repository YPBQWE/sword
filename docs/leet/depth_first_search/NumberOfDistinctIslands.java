 ...
 * 4-directionally (horizontal or vertical.) You may assume all four edges of the grid are surrounded by water.
 ...
 1
 11
 are considered different island islands, because we do not consider reflection / rotation.
 Note: The length of each dimension in the given grid does not exceed 50.

 Solution: O(N x M) create a signature of each island based on the direction and then use a hashset to count the
 islands.
 */
