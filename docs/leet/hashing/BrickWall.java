...
/**
 * Created by gouthamvidyapradhan on 19/01/2018.
 ...
 * the same height but different width. You want to draw a vertical line from the top to the bottom and cross the least bricks.
 ...
 Solution: O(N) where N is the total number of bricks. Calculate the prefix sum for each row of bricks and
 keep a max_count of each occurrence of prefix. The answer is total number of rows of bricks - max_count
 */
