 ...
 * represented by strings.
 ...
 Solution:O(N) maintain index of each restaurant in a list using a HashMap, find the min sum of indices and list
 all the restaurants which match the min sum of indices
