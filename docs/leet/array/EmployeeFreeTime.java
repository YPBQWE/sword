 ...
 *
 * Solution: O(L X N x N) Where L is the number of schedules, N is the length of schedules for each employee.
 * Merge all the intervals to form a single merged array, now by using this array form a result array with the intervals
 * which form the free time.
 *
 */
