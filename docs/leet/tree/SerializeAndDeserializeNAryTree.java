...
/**
 * Created by gouthamvidyapradhan on 16/03/2019
 ...
 *    5  6
 *
 * as [1 [3[5 6] 2 4]]. You do not necessarily need to follow this format, so please be creative and come up with
 ...
 * Do not use class member/global/static variables to store states. Your serialize and deserialize algorithms should
 * be stateless.
 *
 * Solution: To encode recursively iterate through each node and build a root and its children as 3[5,6] where 3 is the
 * root and 5, 6 are its children.
 * To decode, build the root node first and then recursively build its children.
 */
