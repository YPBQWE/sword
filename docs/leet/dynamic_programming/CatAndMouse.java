 ...
 *
 * Solution: Each combination of mouse, cat and turn for a state (m, c, p). Transition between different states form
 * a state graph - start to color each state with either MOUSE, CAT or a DRAW based on who wins this state. Perform a
 * bottom up dp inorder to arrive at the answer.
 */
public class CatAndMouse {
    ...
    private void enqueue(Queue<State> queue, List<State> parents, int player, int col, int[][][] color,
                         int[][][] degree){
